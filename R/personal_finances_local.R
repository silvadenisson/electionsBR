...
personal_finances_local <- function(year,
  ...
  .Deprecated("elections_tse", msg = "personal_finances_local is deprecated and will no longer be supported in electionsBR 1.0.0. Please use the elections_tse function")
