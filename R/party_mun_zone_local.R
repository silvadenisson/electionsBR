...
party_mun_zone_local <- function(year, uf = "all", ascii = FALSE, 
  ...
  if(year <= 2008){
    ...
    names(banco) <- c(
      ...
      "NOME_TIPO_ELEICAO","NUM_TURNO","COD_ELEICAO",
      "DESCRICAO_ELEICAO","DATA_ELEICAO","ABRANGENCIA",
      "SIGLA_UF","SIGLA_UE","NOME_UE","CODIGO_MUNICIPIO",
      "NOME_MUNICIPIO","NUMERO_ZONA","CODIGO_CARGO",
      "DESCRICAO_CARGO","TIPO_LEGENDA","NUMERO_PARTIDO",
      "SIGLA_PARTIDO","NOME_PARTIDO","NUMERO_FEDERACAO",
      "NOME_FEDERACAO","SIGLA_FEDERACAO","DES_COMPOSICAO_FEDERACAO",
      "SEQUENCIAL_LEGENDA","NOME_COLIGACAO",
      "COMPOSICAO_LEGENDA","TRANSITO","QTDE_VOTOS_LEGENDA_VALIDOS",
      "QTDE_VOTOS_NOMINAIS_CONVR_LEG","QTDE_TOTAL_VOTOS_LEG_VALIDOS",
      "QTDE_VOTOS_NOMINAIS_VALIDOS","QTDE_VOTOS_LEGENDA_ANUL_SUBJUD",
      "QTDE_VOTOS_NOMINAIS_ANUL_SUBJUD"
    )
 }
