...
#'
#' @note For the elections prior to 2002, some information can be incomplete. For the 2014, 2018, 2022, and 2024 elections, more variable are available.
#'
#' @param year Election year. For this function, only the years 1998, 2002, 2006, 2010, 2014, 2018, 2022 and 2024
#' are available.
#' 
...
vote_mun_zone <- function(year, 
  ...
  setwd("..")
  if(readme_pdf){
    file.rename(paste0(year ,"/leiame.pdf"), paste0("readme_vote_mun_zone_", year,".pdf"))
  }
