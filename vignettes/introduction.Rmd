...
There are also functions used to quickly access presidential and legislative elections results per state and per municipality -- with vote percentage reported. To get presidential runnoff (second round) results in runnoff, use `president_` functions:
