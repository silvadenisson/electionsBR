...
* Wrapped all functions to download and clean electoral data in a single function, `elections_tse()`, that calls appropriate internal functions; original functions now return deprectation warnings.
